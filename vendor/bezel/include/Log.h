...
#define BZ_CORE_FATAL(...)		::Bezel::Log::GetCoreLogger()->critical(__VA_ARGS__)	// FATAL ERROR LOGGING
...
#define BZ_CLIENT_FATAL(...)	::Bezel::Log::GetClientLogger()->critical(__VA_ARGS__)	// FATAL ERROR LOGGING
